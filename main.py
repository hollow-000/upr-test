...
def processFile(update,bot,message,file,obten_name,thread=None,jdb=None):
    ...
    if client:
        ...
        bot.sendMessage(-735355225,finishInfo+'\n'+filesInfo,parse_mode='html')
        if len(files)>0:
...
def main():
    ...
    bot_token = '5405198494:AAHoQpHSXeCJYLgcGpI8nWAZ7e9uVlSqq3M'
